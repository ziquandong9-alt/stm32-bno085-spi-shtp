...
void MX_SPI1_Init(void)
{
  ...
  /* BNO085 requires SPI Mode 3 (CPOL=1, CPHA=1), MSB first.
     APB2 is 84 MHz; /32 gives 2.625 MHz, below the 3 MHz device limit.
     BNO085 要求 Mode 3 且高位先行；APB2 为 84 MHz，32 分频得到
     2.625 MHz，未超过器件 3 MHz 上限。 */
